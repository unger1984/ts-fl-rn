...
import { settingsAllCategorySelector, settingsCategoryesSelector, SettingsState } from './settings';
...
export const setSeenTimeout = (timeout: any): ProjectsAction => ({
...
export const getProjectsList = (page = 1): Function => (
